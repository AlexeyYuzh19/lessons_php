...
$h1 = 'Урок 3. Циклы и массивы<br><span style="color: #013b33;">Практическое задание</span>';
$cities = [
    ...
    <main>
        ...
        function generateQuote()  // функция генерации цитаты
        {
            $quotes = [
                ...
                'Если мы не научимся лучше пользоваться машинами, у нас не станет времени для того, чтобы наслаждаться деревьями и птицами, цветами и лугами. - Генри Форд',

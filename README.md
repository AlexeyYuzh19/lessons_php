...
4. Создать страницу каталога товаров.<br>
a. Товары хранятся в БД (структура прилагается).<br>
b. Страница формируется автоматически.<br>
c. По клику на товар открывается карточка товара с подробным описанием.<br>
...
### [http://s96763eu.beget.tech/PHP/lesson_6/calculator/calculator.php] ("Переход на сайт на страницу 'Урок 6 PHP' - http://s96763eu.beget.tech/PHP/lesson_6/calculator/calculator.php") - задания 1 и 2.
...
1. Создать модуль корзины, в которую можно как добавлять товары, так и удалять их из неё.<br>Использовать также сущность good в качестве товара!
...
## Решение:
### [http://s96763eu.beget.tech/PHP/lesson_renovation/public/index.php?lesson=lesson_7&nam=7] ("Переход на сайт на страницу 'Урок 7 PHP' - http://s96763eu.beget.tech/PHP/lesson_renovation/public/index.php?lesson=lesson_7&nam=7).
...
## Решение:
### [http://s96763eu.beget.tech/PHP/lesson_renovation/public/index.php?lesson=lesson_8&nam=8] ("Переход на сайт на страницу 'Урок 8 PHP' - http://s96763eu.beget.tech/PHP/lesson_renovation/public/index.php?lesson=lesson_8&nam=8).
